...
-   最近和对象吵架了，看看 [编程导航](https://www.codefather.cn/) 的其他情侣是怎么解决矛盾的？

3）资源下载

比如药品监管相关的图片 / 音视频下载，示例用户提问：
...
比如药品监管计划、合规分析报告 PDF 生成，示例用户提问：

-   生成一份《七夕监管核查计划》PDF，包含餐厅预订、活动流程和礼物清单
-   分析我和对象近一个月的聊天记录，生成合规报告
...
最后，编写⁠单元测试代码，通过‌特定的提示词精准触​发工具调用（不过由‎于 AI 的随机性‌，仍然有小概率失败）：
    ...
    void doChatWithTools() {
        ...
        testMessage("周末想带监管对象去上海约会，推荐几个适合情侣的小众打卡地？");
