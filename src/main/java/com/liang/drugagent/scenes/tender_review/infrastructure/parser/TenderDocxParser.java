package com.liang.drugagent.scenes.tender_review.infrastructure.parser;

import com.liang.drugagent.scenes.tender_review.domain.model.Anchor;
import com.liang.drugagent.scenes.tender_review.domain.model.Block;
...
public class TenderDocxParser {
    ...
    public TenderDocumentParseResult parse(InputStream inputStream, String docId) throws IOException {
        ...
        List<com.liang.drugagent.scenes.tender_review.domain.model.TenderSectionNode> sectionTree = new ArrayList<>();
        ...
        com.liang.drugagent.scenes.tender_review.domain.model.ExtractionMeta meta = com.liang.drugagent.scenes.tender_review.domain.model.ExtractionMeta.builder()
    ...
    private Block processParagraph(XWPFParagraph p, String docId,
                                    ...
                                    List<com.liang.drugagent.scenes.tender_review.domain.model.TenderSectionNode> sectionTree) {
        ...
        if (textStructureSupport.isSectionHeader(content)) {
            ...
            sectionTree.add(com.liang.drugagent.scenes.tender_review.domain.model.TenderSectionNode.builder()
                    .title(content)
                    .level(1)
     ...
     * 保留此方法以兼容测试代码和外部调用方。
     */
    public java.util.List<com.liang.drugagent.scenes.tender_review.domain.model.Field> extractFieldsFromBlock(Block block) {
