package com.liang.drugagent.application.agent;
...
public class AgentApplicationService {
    ...
    private void hydrateTenderMetadata(DrugAgentReq req, String submittedBy, MultipartFile[] files) {
        ...
        List<com.liang.drugagent.domain.tenderreview.TenderDocument> documents = new ArrayList<>();
        List<com.liang.drugagent.domain.tenderreview.Block> blocks = new ArrayList<>();
        List<com.liang.drugagent.domain.tenderreview.Field> fields = new ArrayList<>();
        var extractionMeta = new com.liang.drugagent.domain.tenderreview.ExtractionMeta();
        ...
        var data = new com.liang.drugagent.domain.tenderreview.TenderReviewData();
    ...
    private com.liang.drugagent.domain.tenderreview.TenderCase buildTenderCase(String caseId, String submittedBy, List<String> documentIds) {
        var tenderCase = new com.liang.drugagent.domain.tenderreview.TenderCase();
    ...
    private com.liang.drugagent.domain.tenderreview.TenderDocument buildTenderDocument(String caseId, String docId, String filename) {
        var document = new com.liang.drugagent.domain.tenderreview.TenderDocument();
    ...
    private List<com.liang.drugagent.domain.tenderreview.CompareScope> buildCompareScopes(List<String> documentIds) {
        if (documentIds == null || documentIds.size() < 2) {
            return List.of();
        }
        var compareScope = new com.liang.drugagent.domain.tenderreview.CompareScope();
