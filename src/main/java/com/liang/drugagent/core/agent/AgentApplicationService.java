...
import com.liang.drugagent.scenes.tender_review.application.services.TenderCaseService;
import com.liang.drugagent.scenes.tender_review.application.services.TenderDocumentParseService;
...
public class AgentApplicationService {
    ...
    private void hydrateTenderMetadata(DrugAgentReq req, String submittedBy, MultipartFile[] files) {
        ...
        var caseResp = tenderCaseService.createCase(
                com.liang.drugagent.interfaces.http.request.tender_review.TenderCaseCreateReq.builder()
                        .filenames(filenames)
                        .submittedBy(submittedBy)
                        .build());

        List<com.liang.drugagent.scenes.tender_review.domain.model.TenderDocument> documents = new ArrayList<>();
        List<com.liang.drugagent.scenes.tender_review.domain.model.Block> blocks = new ArrayList<>();
        List<com.liang.drugagent.scenes.tender_review.domain.model.Field> fields = new ArrayList<>();
        var extractionMeta = new com.liang.drugagent.scenes.tender_review.domain.model.ExtractionMeta();
        ...
        var data = new com.liang.drugagent.scenes.tender_review.domain.model.TenderReviewData();
    ...
    private com.liang.drugagent.scenes.tender_review.domain.model.TenderCase buildTenderCase(String caseId, String submittedBy, List<String> documentIds) {
        var tenderCase = new com.liang.drugagent.scenes.tender_review.domain.model.TenderCase();
    ...
    private com.liang.drugagent.scenes.tender_review.domain.model.TenderDocument buildTenderDocument(String caseId, String docId, String filename) {
        var document = new com.liang.drugagent.scenes.tender_review.domain.model.TenderDocument();
    ...
    private List<com.liang.drugagent.scenes.tender_review.domain.model.CompareScope> buildCompareScopes(List<String> documentIds) {
        if (documentIds == null || documentIds.size() < 2) {
            return List.of();
        }
        var compareScope = new com.liang.drugagent.scenes.tender_review.domain.model.CompareScope();
