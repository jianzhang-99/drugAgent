...
public record ReviewTenderToolRequest(
     ...
     * 紧凑构造方法，初始化空集合。
     */
    public ReviewTenderToolRequest {
        if (fileIds == null) {
     ...
     * 创建默认请求。
     */
    public static ReviewTenderToolRequest empty() {
        return new ReviewTenderToolRequest(null, new ArrayList<>(), null, null, false);
    }

    /**
     * 创建请求（简化版，只提供文件ID列表）。
     */
    public static ReviewTenderToolRequest of(List<String> fileIds) {
        return new ReviewTenderToolRequest(null, fileIds, null, null, false);
    }

    /**
     * 创建请求。
     */
    public static ReviewTenderToolRequest of(String sessionId, List<String> fileIds, String reviewFocus) {
        return new ReviewTenderToolRequest(sessionId, fileIds, reviewFocus, null, false);
    }
    ...
    public static ReviewTenderToolRequest of(String sessionId, List<String> fileIds, String reviewFocus,
        ...
        return new ReviewTenderToolRequest(sessionId, fileIds, reviewFocus, userInstruction, needStructuredReport);
    }
    ...
    public boolean equals(Object o) {
        ...
        ReviewTenderToolRequest that = (ReviewTenderToolRequest) o;
    ...
    public String toString() {
        return "ReviewTenderToolRequest{" +
                "sessionId='" + sessionId + '\'' +
