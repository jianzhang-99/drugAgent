package com.liang.drugagent.shared_capabilities.llm;

import com.liang.drugagent.core.contracts.llm.LlmClient;
...
public class LlmFacadeService {
     ...
     * 获取默认provider
     */
    public LlmProviderType getDefaultProvider() {
        return defaultProvider;
    }
     ...
     * 获取所有可用provider
     */
    public java.util.List<LlmProviderType> getAvailableProviders() {
        return clientFactory.getAvailableProviders();
    }
}
